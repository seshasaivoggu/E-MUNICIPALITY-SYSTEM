...
$sql1="select compid,complaint,compstatus from complaint where compstatus='';";
...
<br><br>
<form>
<input type='button' name='Update Details' value='Update Details' onclick='update()'>&nbsp&nbsp&nbsp&nbsp
